...
namespace ProFit.Data.Migrations
{
    ...
    [Migration("20250518113343_addFavoritesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProFit.Core.Entities.RecruiterFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProFit.Core.Entities.RecruiterFavorite", b =>
                {
                    b.HasOne("ProFit.Core.Entities.Application", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProFit.Core.Entities.User", "Recruiter")
                        .WithMany()
                        .HasForeignKey("RecruiterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
